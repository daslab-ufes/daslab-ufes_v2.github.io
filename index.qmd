...
.hero_content {
  ...
  *, *::before, *::after {
        white-space: normal !important; /* Quebra de linha ativada para telas menores */
  }
    ...
    <section id="intro">   
      <div class="intro-overlay"></div>	
        <div class="intro-content">
          <img src="tech_background.jpg" class="img-padrao" width="100%" height="848.5">
      ...
      <!-- <div class="container"> -->
        ...
        <!-- <div class="split">
          <a href="#" class="featured__item">
            <img src="img\daslab.png" alt="" class="featured__img">
          </a>
        </div> -->
        <!-- ----------------------------------------------------------------- -->
      <!-- </div> -->
